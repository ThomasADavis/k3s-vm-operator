{
  _config+:: {
    ...
    cadvisorSelector: 'job="monitoring/cadvisor-metrics"',
    kubeletSelector: 'job="k3s-server"',
    kubeStateMetricsSelector: 'job="kube-state-metrics"',
    nodeExporterSelector: 'job="node-exporter"',
    kubeSchedulerSelector: 'job="k3s-server"',
    kubeControllerManagerSelector: 'job="k3s-server"',
    kubeApiserverSelector: 'job="k3s-server"',
    kubeProxySelector: 'job="k3s-server"',
    podLabel: 'pod',
